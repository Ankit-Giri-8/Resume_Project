...
export const TemplateCard = ({thumbnailImg, isSelected, onSelect}) => {
  return (
    <div className={`group h-auto md:h-[300px] lg:h-[320px] flex flex-col bg-white overflow-hidden border-2 cursor-pointer transition-all duration-500 hover:scale-150 hover:shadow-lg rounded-3xl ${
      isSelected ? 'border-violet-500 shadow-lg shadow-violet-500/20 bg-violet-50'
      : 'bg-gray-200 hover:border-violet-300'
    }`} onClick={onSelect}>
        {thumbnailImg ? (
          ...
          <div className="w-full h-[200px] flex flex-col items-center justify-center bg-gradient-to-br from-violet-50 via-violet-600 to-fuchsia-50">
